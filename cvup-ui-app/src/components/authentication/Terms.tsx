    ...
    <Grid container>
      <Grid item xs={12} sx={{ margin: 4 }}>
        ...
        <p>
          ...
          use of CvUp's Website, located at www.CvUp.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use CvUp if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing CvUp, you agreed to use
          cookies in agreement with the CvUp's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, CvUp and/or its licensors own the
          intellectual property rights for all material on CvUp. All
          intellectual property rights are reserved. You may access this from
          CvUp for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from CvUp</li>
          <li>Sell, rent or sub-license material from CvUp</li>
          <li>Reproduce, duplicate or copy material from CvUp</li>
          <li>Redistribute content from CvUp</li>
        </ul>
        ...
        <p>
          ...
          CvUp does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of CvUp,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, CvUp shall not be liable for
        ...
        <p>
          CvUp reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant CvUp a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of CvUp; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to CvUp. Please include your name, your organization
        ...
        <p>
          No use of CvUp's logo or other artwork will be allowed for linking
